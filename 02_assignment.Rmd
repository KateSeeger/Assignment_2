...
The hotel should consider the people who have a high probability of canceling (look at features such as room type and refund options), they could measure whether is was worth the effort to do the calling to 
...
I would ask more questions on the types of hotels that people are renting from, as resorts and large hotels attract a certain 
...
I found this chapter to be very eye opening in relation to the motivations behind data science and data collection and the intentional or unintentional impacts of bias on data collection. I was really impacted by the section on the data correlation between being lower income and  
...
I think that that the article had a really good summation of the motivations for data science, "science, surveillance, and selling". 
